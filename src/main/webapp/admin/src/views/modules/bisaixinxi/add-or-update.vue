          ...
          <el-form-item class="input" label="比赛名称" prop="bisaimingcheng">
              <el-input v-model="ruleForm.bisaimingcheng" 
                placeholder="比赛名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="比赛项目" prop="bisaixiangmu">
          <el-select v-model="ruleForm.bisaixiangmu" placeholder="请选择比赛项目">
            <el-option
          ...
          <el-form-item class="input" label="比赛地点" prop="bisaididian">
              <el-input v-model="ruleForm.bisaididian" 
                placeholder="比赛地点" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="比赛要求" prop="bisaiyaoqiu">
          <el-input v-model="ruleForm.bisaiyaoqiu" 
              placeholder="比赛要求" clearable  :readonly="ro.bisaiyaoqiu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="比赛要求" prop="bisaiyaoqiu">
              <el-input v-model="ruleForm.bisaiyaoqiu" 
                placeholder="比赛要求" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                            </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.bisaineirong = this.ruleForm.bisaineirong.replace(reg,'../../../ssm4o4c3/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
